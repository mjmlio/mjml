...
| -------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| fill-space           | string  | number of spacing units appended after preview text to prevent clients from pulling body copy into the inbox preview. Set to a positive value to enable. | `0`                     |
