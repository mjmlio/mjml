...
| attribute                    | accepts           | description                                | default value |
| ---------------------------- | ----------------- | ------------------------------------------ | ------------- |
| background-color--dark       | CSS color formats | hero background color in dark mode         |               |
| background-url--dark         | string            | hero background image URL in dark mode     |               |
| inner-background-color--dark | CSS color formats | hero content background color in dark mode |               |
