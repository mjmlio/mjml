...
class Section extends Component {
  ...
  getStyles () {
    ...
    const background = mjAttribute('background-url') ? {
      background: `${(mjAttribute('background-color')) ? mjAttribute('background-color') + ' ' : ''}url(${mjAttribute('background-url')}) top center / ${mjAttribute('background-size') || ''} ${mjAttribute('background-repeat') || ''}`
    } : {
