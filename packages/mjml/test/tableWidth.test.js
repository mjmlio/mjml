          ...
          <mj-section>
            <mj-column>
              <mj-table width="500px" css-class="table">
                <tr>
                  <th style="border: 1px solid black;text-align: left;">Pixel Width</th>
                  <td style="border: 1px solid black;">500px</td>
                </tr>
              </mj-table>
            </mj-column>
          </mj-section>
          <mj-section>
            <mj-column>
              <mj-table width="80%" css-class="table">
                <tr>
                  <th style="border: 1px solid black;text-align: left;">Percentage Width</th>
          ...
          <mj-section css-class="section">
            <mj-column>
              <mj-table width="auto" css-class="table">
                <tr>
                  <th style="border: 1px solid black;text-align: left;">Auto Width</th>
